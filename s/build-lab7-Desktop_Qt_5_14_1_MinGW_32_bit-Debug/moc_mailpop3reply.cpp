...
#include <memory>
#include "../lab7/mail/mailpop3reply.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QxtPop3Reply_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QxtPop3Reply_t qt_meta_stringdata_QxtPop3Reply = {
    {
QT_MOC_LITERAL(0, 0, 12), // "QxtPop3Reply"
...
QT_MOC_LITERAL(5, 37, 7) // "percent"
    ...
    "QxtPop3Reply\0finished\0\0code\0progress\0"
    "percent"
};
...
void QxtPop3Reply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QxtPop3Reply::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QxtPop3Reply::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QxtPop3Reply::progress)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QxtPop3Reply::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QxtPop3Reply.data,
