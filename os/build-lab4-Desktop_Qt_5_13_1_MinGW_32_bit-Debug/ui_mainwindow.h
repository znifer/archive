...
public:
    ...
    QLabel *label_2;
    QComboBox *chooseProcess;
    QTableWidget *virtualMemoryMap;
    QWidget *charts;
    QWidget *vcharts;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        chooseProcess = new QComboBox(map);
        chooseProcess->setObjectName(QString::fromUtf8("chooseProcess"));

        horizontalLayout_2->addWidget(chooseProcess);


        verticalLayout->addLayout(horizontalLayout_2);

        virtualMemoryMap = new QTableWidget(map);
        virtualMemoryMap->setObjectName(QString::fromUtf8("virtualMemoryMap"));

        verticalLayout->addWidget(virtualMemoryMap);

        tabWidget->addTab(map, QString());
        charts = new QWidget();
        charts->setObjectName(QString::fromUtf8("charts"));
        tabWidget->addTab(charts, QString());
        vcharts = new QWidget();
        vcharts->setObjectName(QString::fromUtf8("vcharts"));
        tabWidget->addTab(vcharts, QString());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QCoreApplication::translate("MainWindow", "\320\237\321\200\320\276\321\206\320\265\321\201\321\201:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(map), QCoreApplication::translate("MainWindow", "Tab 2", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(charts), QCoreApplication::translate("MainWindow", "\320\241\321\202\321\200\320\260\320\275\320\270\321\206\320\260", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(vcharts), QCoreApplication::translate("MainWindow", "\320\241\321\202\321\200\320\260\320\275\320\270\321\206\320\260", nullptr));
    } // retranslateUi
